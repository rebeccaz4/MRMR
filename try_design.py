...
def main():
    tasks = mteb.get_tasks(tasks=["DesignIT2AnyRetrieval"])
    ...
    evaluation = mteb.MTEB(tasks=tasks, device="cuda:0")
    ...
    results = evaluation.run(
        ...
        output_folder="/home/siyue/Projects/results_design_textvision",
    )
