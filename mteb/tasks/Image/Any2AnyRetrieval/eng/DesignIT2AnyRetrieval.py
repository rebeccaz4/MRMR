...
""",
        prompt={"query": "Given a vehicle design, retrieve the design requirements that it violates."},
        descriptive_stats={
    ...
    def load_data(self, **kwargs):
        ...
        if text_vision:
            self.metadata.prompt["query"] = (
                "Given a vehicle design description, retrieve the design requirements that it violates."
            )
        else:
            self.metadata.prompt["query"] = (
                "Given a vehicle design, retrieve the design requirements that it violates. "
            )
